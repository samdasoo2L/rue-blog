    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register.post') }}">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    ...
                    <input id="nickname" name="nickname" type="text" required 
                           ...
                           placeholder="닉네임" value="{{ old('nickname') }}">
                </div>
                <div>
                    <label for="email" class="sr-only">이메일</label>
                    <input id="email" name="email" type="email" required 
                           class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" 
                           placeholder="이메일 주소" value="{{ old('email') }}">
                </div>
                <div>
            ...
            <div class="mt-6">
                ...
                class="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-gray-800 text-white text-sm font-medium hover:bg-gray-700 transition-colors duration-200">
